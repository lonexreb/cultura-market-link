        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-slate-200 text-base">Customize default settings for AI nodes</p>
            </div>
          </div>
          ...
          {alert && (
            ...
            >
              <Alert className={`${alert.type === 'success' ? 'border-green-500/50 bg-green-500/10' : 'border-red-500/50 bg-red-500/10'}`}>
                ...
                <AlertDescription className={alert.type === 'success' ? 'text-green-100 text-base' : 'text-red-100 text-base'}>
                  {alert.message}
                </AlertDescription>
              </Alert>
            </motion.div>
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <CardTitle className="text-2xl text-white">{displayName} Configuration</CardTitle>
                        ...
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            variant="outline"
                            size="md"
                            className="border-slate-600 text-slate-100 hover:bg-slate-700 hover:text-white text-base"
                          >
                          ...
                          <Button
                            ...
                            size="md"
                            className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white text-base"
                          >
                      ...
                      {configs[nodeType] && (
                        <>
                          ...
                          <div className="space-y-4">
                            <label className="text-base font-medium text-white">Model</label>
                            <Select
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between">
                              <label className="text-base font-medium text-white">Temperature</label>
                              <span className="text-base text-white">{configs[nodeType].temperature}</span>
                            </div>
                            <Slider
                              ...
                              className="w-full"
                            />
                            <p className="text-sm text-white">Controls randomness in responses (0 = deterministic, 2 = very creative)</p>
                          </div>

                          {/* Max Tokens */}
                          <div className="space-y-4">
                            <label className="text-base font-medium text-white">Max Tokens</label>
                            <Input
                              type="number"
                            ...
                            />
                            <p className="text-sm text-white">Maximum length of the generated response</p>
                          </div>

                          {/* System Prompt */}
                          <div className="space-y-4">
                            <label className="text-base font-medium text-white">System Prompt</label>
                            <Textarea
                              value={configs[nodeType].system_prompt}
                              onChange={(e) => handleConfigChange(nodeType, 'system_prompt', e.target.value)}
                              rows={3}
                              className="bg-slate-800 border-slate-600 resize-none text-white"
                              placeholder="Define the AI's role and behavior..."
                            />
                            <p className="text-sm text-white">Sets the AI's personality and behavior guidelines</p>
                          </div>

                          {/* User Prompt */}
                          <div className="space-y-4">
                            <label className="text-base font-medium text-white">Default User Prompt</label>
                            <Textarea
                            ...
                            />
                            <p className="text-sm text-white">Default prompt template that will be used if no input is provided</p>
                          </div>
                        </>
                      )}
                    </CardContent>
